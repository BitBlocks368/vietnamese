...
Trong bài ôn tập này, bạn sẽ - In this revision lesson, you will:

- ✓ Nhận biết các phần CỐ ĐỊNH và THAY ĐỔI trong câu - Recognize FIXED and VARIABLE parts in sentences
- ✓ Tạo câu mới với thông tin cá nhân của bạn - Create new sentences with your personal information
- ✓ Thực hành các mẫu câu với thông tin thực tế - Practice sentence patterns with real information
- ✓ Ghi hình video để tạo tài nguyên học tập - Record videos to create learning resources
- ✓ Áp dụng các mẫu câu vào tình huống thực tế - Apply sentence patterns to real situations

## Từ vựng mới - New Vocabulary

**KHÔNG CÓ TỪ MỚI** - **NO NEW VOCABULARY**

Bài học này chỉ sử dụng từ vựng từ Bài học 01 và 02.
This lesson uses only vocabulary from Lessons 01 and 02.

## Phần 1: Nhận biết mẫu câu - Section 1: Pattern Recognition
...
### Bài tập 1.1: Phân tích mẫu câu - Exercise 1.1: Pattern Analysis
...
### Bài tập 1.2: Ghép cặp mẫu câu - Exercise 1.2: Pattern Matching
...
**VIDEO HOẠT ĐỘNG 1.3 - VIDEO ACTIVITY 1.3**

**Ghi hình: Thư viện mẫu câu - Record: Pattern Library**

Ghi 3 video, mỗi video cho 1 mẫu câu:
...
- Giáo viên nói (EN): **[I am]** _{[teacher's name]}_
...
## Phần 2: Ngân hàng thông tin cá nhân - Section 2: Personal Information Bank

### Bài tập 2.1: Xây dựng hồ sơ của bạn - Exercise 2.1: Build Your Profile

**Hướng dẫn - Instructions:**
Điền thông tin THẬT của bạn vào bảng.
Fill in your REAL information in the table.
...
These words will become the VARIABLE parts in your exercises.

### Bài tập 2.2: Câu giới thiệu của bạn - Exercise 2.2: Your Introduction Sentences

**Dùng thông tin từ Bài tập 2.1, viết câu của BẠN:**
**Using information from Exercise 2.1, write YOUR sentences:**
...
**Ghi hình: Giới thiệu cá nhân - Record: Personal Introduction**

**Video học viên - Student's video:**

Ghi hình học viên nói (nhìn vào máy quay):
...
**[Tôi sống ở]** _{[thành phố]},_ _{Úc}_
**[Tôi đang học]** _{tiếng Anh}_
**[Tôi thích]** _{[đồ ăn]}_
```
...
**[I live in]** _{[city]},_ _{Australia}_
**[I am learning]** _{English}_
**[I like]** _{[food]}_
```

Lưu dưới tên - Save as: `02-Student-Personal/Student-Introduction.mp4`

**Video giáo viên - Teacher's video:**

Làm tương tự với thông tin của giáo viên.
Do the same with teacher's information.

Lưu dưới tên - Save as: `03-Teacher-Personal/Teacher-Introduction.mp4`

---

## Phần 3: Luyện tập thay thế có hướng dẫn - Section 3: Guided Substitution Drills

### Bài tập 3.1: Mẫu giới thiệu - Drill 3.1: Introduction Pattern

**Mẫu - Template:** `**[Tôi là]** + _{TÊN}_ = **[I am]** + _{NAME}_`
...
**Mẫu - Template:** `**[Tôi đang học]** + _{NGÔN NGỮ}_ = **[I am learning]** + _{LANGUAGE}_`
...
**Mẫu - Template:** `**[Tôi thích]** + _{ĐỒ ĂN}_ = **[I like]** + _{FOOD}_`
...
**Ghi hình: Luyện tập thay thế - Record: Substitution Practice**
...
Giáo viên (VN): **[Tôi là]** _{[tên]}_
Học viên (EN): **[I am]** _{[cùng tên]}_
```
...
- Không thích đồ ăn - Food dislike
- Lời chào gặp mặt - Meeting greeting

Lưu dưới tên - Save as: `04-Dialogue-Practice/Substitution-Drills.mp4`

---

## Phần 4: Hội thoại nhỏ được cá nhân hóa - Section 4: Personalized Mini-Dialogues

### Hội thoại 4.1: Gặp đối tác trao đổi ngôn ngữ - Dialogue 4.1: Meeting Your Language Partner

**QUAN TRỌNG - IMPORTANT:** Sử dụng TÊN THẬT và THÔNG TIN THẬT của bạn!
**Use YOUR REAL NAMES and REAL INFORMATION!**
...
Giáo viên: _________________________________________________________________
...
### Hội thoại 4.2: Nói về đồ ăn - Dialogue 4.2: Talking About Food
...
1. Bắt đầu với hội thoại viết - Start with written dialogue
2. Xóa tên/đồ ăn, học viên điền vào - Remove names/foods, student fills in
3. Luyện phiên bản nói - Practice spoken version
4. Nhấn mạnh - Emphasize: "Đây là câu của BẠN, không phải câu của An!" - "This is YOUR sentence, not An's sentence!"

**VIDEO HOẠT ĐỘNG 4.3 - VIDEO ACTIVITY 4.3**
...
**Hội thoại 1: Gặp mặt tại quán cà phê - Dialogue 1: Meeting at Café**

Ghi hội thoại hoàn chỉnh với tên/thông tin THẬT:
Record complete dialogue with REAL names/information:

Lưu dưới tên - Save as: `04-Dialogue-Practice/Dialogue-01-Meeting.mp4`

**Hội thoại 2: Thảo luận về đồ ăn - Dialogue 2: Food Discussion**

Lưu dưới tên - Save as: `04-Dialogue-Practice/Dialogue-02-Food.mp4`

---

## Phần 5: Luyện tập nhận thức ngữ cảnh - Section 5: Context Awareness Training

### Bài tập 5.1: Khi nào tôi dùng cái này? - Exercise 5.1: When Do I Use This?

**Hướng dẫn - Instructions:**
Đọc tình huống, xác định mẫu câu nào cần dùng.
Read the situation, identify which pattern to use.

**Tình huống 1 - Situation 1:**
Bạn gặp người mới tại quán cà phê.
...
You want to ask someone's name.

→ **Mẫu cần dùng - Pattern needed:** Câu hỏi tên - Name question **[Bạn là ai?]** / **[Tên bạn là gì?]**
→ **Bạn nói - You say:** **[Xin lỗi, bạn là ai?]** / **[Tên bạn là gì?]**

**Tình huống 5 - Situation 5:**
Bạn muốn hỏi ai đó có thích đồ ăn cay không.
You want to ask if someone likes spicy food.

→ **Mẫu cần dùng - Pattern needed:** Câu hỏi sở thích - Preference question **[Bạn có thích... không?]**
→ **Bạn nói - You say:** **[Bạn có thích]** _{đồ ăn cay}_ **[không?]**

### Bài tập 5.2: Thẻ tín hiệu đóng vai - Exercise 5.2: Role-Play Signal Cards
...
4. Thẻ 2 = Dùng tên An/Ben từ bài học - Card 2 = Use An/Ben from lessons

**VIDEO HOẠT ĐỘNG 5.3 - VIDEO ACTIVITY 5.3 (Tùy chọn - Optional)**

**Ghi hình: Tình huống thế giới thực - Record: Real-World Scenarios**
...
## Phần 6: Danh sách kiểm tra sản xuất - Section 6: Production Checklist

### Kiểm tra bản thân - Self-Assessment

**Bạn có thể làm những việc này KHÔNG CẦN nhìn ghi chú không?**
**Can you do these WITHOUT looking at notes?**

**Tiếng Việt:**

□ Nói tên của bạn - Say your name
□ Nói ngôn ngữ bạn đang học - Say what language you're learning
□ Nói ngôn ngữ bạn đang giúp dạy - Say what language you're teaching
□ Hỏi tên của ai đó - Ask someone their name
□ Hỏi ai đó đang học gì - Ask what someone is learning
□ Nói một món ăn bạn thích - Say one food you like
□ Nói một món ăn bạn không thích - Say one food you don't like
□ Hỏi ai đó thích đồ ăn gì - Ask what food someone likes

**English:**

□ Say your name
□ Say what language you're learning
□ Say what language you're teaching/helping with
□ Ask someone their name
□ Ask what language they're learning
□ Say one food you like
□ Say one food you don't like
□ Ask someone what food they like

### Bài kiểm tra - Test

**Giáo viên hỏi những câu hỏi này theo thứ tự ngẫu nhiên.**
**Teacher asks these questions in random order.**
...
**Ghi hình: Đánh giá cuối cùng - Record: Final Assessment**

**Định dạng - Format:** Video hỏi đáp nhanh - Rapid-fire Q&A

Giáo viên hỏi câu hỏi (ngẫu nhiên), học viên trả lời ngay lập tức:
...
1. **Câu hỏi Tiếng Việt → Trả lời Tiếng Việt**
   **Vietnamese questions → Vietnamese answers**
   ...
   Lưu dưới tên - Save as: `04-Dialogue-Practice/Assessment-Vietnamese.mp4`

2. **Câu hỏi Tiếng Anh → Trả lời Tiếng Anh**
   **English questions → English answers**

   Lưu dưới tên - Save as: `04-Dialogue-Practice/Assessment-English.mp4`

---

## Hướng dẫn ghi hình video - Video Recording Guide

### Thiết bị cần thiết - Equipment Needed

- 2 điện thoại thông minh/máy quay (một cho mỗi người) - 2 smartphones/cameras (one for each person)
- Giá đỡ hoặc bề mặt ổn định - Tripod or stable surface
- Ánh sáng tốt (gần cửa sổ hoặc đèn) - Good lighting (near window or lamp)
- Môi trường yên tĩnh - Quiet environment

### Cấu trúc thư viện video - Video Library Structure

```
Revision-01-Videos/
├── 01-Pattern-Examples/
│   ├── Pattern-01-Introduction.mp4
│   ├── Pattern-02-Learning.mp4
│   └── Pattern-03-Preferences.mp4
├── 02-Student-Personal/
│   ├── Student-Introduction.mp4
│   ├── Student-Learning.mp4
│   └── Student-Preferences.mp4
├── 03-Teacher-Personal/
│   ├── Teacher-Introduction.mp4
│   ├── Teacher-Learning.mp4
│   └── Teacher-Preferences.mp4
├── 04-Dialogue-Practice/
│   ├── Substitution-Drills.mp4
│   ├── Dialogue-01-Meeting.mp4
│   ├── Dialogue-02-Food.mp4
│   ├── Assessment-Vietnamese.mp4
│   └── Assessment-English.mp4
└── 05-Native-Speakers/
    ├── Speaker-01-Introduction.mp4
    ├── Speaker-02-Learning.mp4
    └── Speaker-03-Food.mp4
```
...
- Ghi chú về sự tiến bộ - Note improvements over time
...
3. **Sử dụng cho luyện tập một mình - Use for solo practice**
   - Xem video và lặp lại - Watch video and repeat
   - Tắt tiếng và tự nói - Mute and speak yourself
   - So sánh phát âm của bạn - Compare your pronunciation

---

## Chiến lược dạy học - Teaching Strategies
...
### Lỗi thường gặp - Common Mistakes to Anticipate

**Lỗi 1 - Mistake 1:**
Học viên cố dịch từng từ thay vì dùng mẫu.
Student tries to translate word-by-word instead of using pattern.

→ **Giải pháp - Solution:** Quay lại phân tích mẫu, luyện 3 lần nữa - Return to pattern analysis, practice 3 more times

**Lỗi 2 - Mistake 2:**
Không nhận ra "là" không đổi thành "am/is/are" trong Tiếng Việt.
Doesn't realize "là" doesn't change to "am/is/are" in Vietnamese.

→ **Giải pháp - Solution:** Chỉ rõ sự khác biệt, tạo bảng so sánh - Point out difference, create comparison chart

**Lỗi 3 - Mistake 3:**
Học viên đóng băng khi được yêu cầu dùng thông tin của mình.
Student freezes when asked to use own information.

→ **Giải pháp - Solution:** Bắt đầu với thông tin viết sẵn, sau đó ẩn dần - Start with written information, then gradually hide it

**Lỗi 4 - Mistake 4:**
Không nhận ra khi nào áp dụng mẫu đã học.
Doesn't recognize when to apply learned pattern.

→ **Giải pháp - Solution:** Sử dụng thẻ tín hiệu, tạo nhiều tình huống luyện tập - Use signal cards, create multiple practice scenarios

---

## Chỉ số thành công - Success Indicators

Sau bài học này, học viên có thể:
After this lesson, the student can:

- ✓ Giới thiệu bản thân không cần kịch bản (có bằng chứng video)
  Introduce themselves without script (video evidence)

- ✓ Nói đang học gì không cần kịch bản (có bằng chứng video)
  State what learning without script (video evidence)

- ✓ Nhận ra khi mẫu quen thuộc được áp dụng
  Recognize when familiar pattern applies

- ✓ Tạo câu được cá nhân hóa trên camera
  Create personalized sentences on camera

- ✓ Thư viện video chứa 10+ clip tham khảo có thể sử dụng
  Video library contains 10+ usable reference clips

- ✓ Cả hai người tham gia có thể xem lại và tự sửa bằng video
  Both participants can review and self-correct using videos

---

## Tóm tắt - Summary

Trong bài ôn tập này, bạn đã:
In this revision lesson, you:

- ✓ Học cách nhận biết phần CỐ ĐỊNH và THAY ĐỔI trong câu
  Learned how to recognize FIXED and VARIABLE parts in sentences

- ✓ Tạo ngân hàng thông tin cá nhân bằng hai ngôn ngữ
  Created personal information bank in both languages

- ✓ Luyện tập thay thế các phần THAY ĐỔI trong mẫu câu
  Practiced substituting VARIABLE parts in sentence patterns

- ✓ Ghi hình video để tạo tài nguyên học tập cá nhân
  Recorded videos to create personalized learning resources

- ✓ Áp dụng các mẫu câu vào tình huống thực tế
  Applied sentence patterns to real situations

- ✓ Kiểm tra khả năng tạo câu của riêng mình
  Tested ability to create your own sentences

**Lời khuyên cho lần học tiếp theo - Tip for next session:**

Xem video của bạn mỗi ngày! Luyện tập nói cùng với video. Ghi video mới mỗi tuần để thấy sự tiến bộ.

Watch your videos every day! Practice speaking along with the videos. Record new videos each week to see progress.

**Mục tiêu tiếp theo - Next Goal:**

Bây giờ bạn có thể nói về bản thân, hãy học thêm về gia đình, công việc, và sở thích của bạn!

Now you can talk about yourself, learn more about your family, work, and hobbies!

**Chúc bạn luyện tập tốt! - Happy practicing!**
